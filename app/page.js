...
export default function Home() {
  return (
    <>
      ...
      <section className="relative min-h-[90vh] flex flex-col justify-center overflow-hidden px-4 sm:px-8 lg:px-16 pt-20" aria-label="Welcome hero">
        ...
        <div className="relative z-10 w-full max-w-screen-xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12 items-center md:items-start pt-10 lg:pt-0 px-4 sm:px-0">
          ...
          <div className="w-full flex justify-center">
            <div className="group cursor-pointer w-full relative aspect-[4/5] rounded-xl overflow-hidden shadow-[0_20px_40px_-15px_rgba(38,37,36,0.2)] max-w-[280px] lg:max-w-full">
              <Image
          ...
          <div className="w-full flex flex-col justify-center text-center md:text-left">
            <div className="flex items-center justify-center md:justify-start gap-3 mb-4">
              ...
              <p className="font-accent text-xs tracking-[0.4em] uppercase text-prussian-lt">The Artist</p>
            </div>

            <h2 className="font-title text-4xl lg:text-5xl leading-[1.2] mb-4 text-prussian tracking-wide drop-shadow-sm">
              Hi, I&apos;m Asha.
            </h2>

            <p className="font-body text-base lg:text-lg font-light tracking-wide text-prussian-lt/90 leading-relaxed mb-8">
              Art found me when I needed it most. Now I paint nature, stillness and the beauty of everywhere I wander.
            </p>

            <div>
              <Link href="/about" className="group inline-flex items-center justify-center px-8 py-3 bg-prussian text-white rounded-full font-medium transition-all shadow-xl hover:shadow-2xl hover:bg-prussian-lt text-xs tracking-wide">
          ...
          <div className="w-full flex flex-col justify-center text-center md:text-left">
            <div className="flex items-center justify-center md:justify-start gap-3 mb-4">
              <div className="w-8 h-[1px] bg-prussian/30 hidden md:block"></div>
              <p className="font-accent text-xs tracking-[0.4em] uppercase text-prussian-lt">Original Artistry</p>
            </div>

            <h2 className="font-title text-4xl lg:text-5xl leading-[1.2] mb-4 text-prussian tracking-wide drop-shadow-sm">
              Quiet Botanicals.<br />
              <span className="text-sage/90 block my-1">Nature-Led.</span>
              Deeply Personal.
            </h2>
            ...
            <div>
              <Link href="/shop" className="group inline-flex items-center justify-center px-8 py-3 bg-prussian text-white rounded-full font-medium transition-all shadow-xl hover:shadow-2xl hover:bg-prussian-lt text-xs tracking-wide">
      ...
      {/* ── NATURE COLLECTION ── */}
      <section className="py-32 relative z-10 bg-[#eaf0ea]/80" aria-label="Nature Collection">
        <div className="max-w-screen-xl mx-auto px-4 sm:px-8 lg:px-16">

          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-16">
            <div className="max-w-2xl">
              <h2 className="font-display text-4xl md:text-5xl leading-tight text-prussian tracking-tight">Nature Collection —<br />Grounded & Still</h2>
            </div>
            <Link href="/shop" className="px-6 py-3 glass-panel bg-white/60 hover:bg-white/80 rounded-full text-sm font-medium text-prussian transition-all shadow-md backdrop-blur-xl border border-white/60">
              Explore Nature
            </Link>
          </div>
      ...
      {/* ── OCEAN COLLECTION ── */}
      <section className="py-32 relative z-10 bg-[#e6f0f2]/80" aria-label="Ocean Collection">
        <div className="max-w-screen-xl mx-auto px-4 sm:px-8 lg:px-16">

          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-16">
            <div className="max-w-2xl">
              <h2 className="font-display text-4xl md:text-5xl leading-tight text-prussian tracking-tight">Ocean Collection —<br />Fluid & Deep</h2>
            </div>
            <Link href="/shop" className="px-6 py-3 glass-panel bg-white/60 hover:bg-white/80 rounded-full text-sm font-medium text-prussian transition-all shadow-md backdrop-blur-xl border border-white/60">
              Explore Ocean
            </Link>
      ...
      {/* ── MOUNTAIN COLLECTION ── */}
      <section className="py-32 relative z-10 bg-[#f2efe9]/80" aria-label="Mountain Collection">
        <div className="max-w-screen-xl mx-auto px-4 sm:px-8 lg:px-16">

          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-16">
            <div className="max-w-2xl">
              <h2 className="font-display text-4xl md:text-5xl leading-tight text-prussian tracking-tight">Mountain Collection —<br />Quiet Summits</h2>
            </div>
            <Link href="/shop" className="px-6 py-3 glass-panel bg-white/60 hover:bg-white/80 rounded-full text-sm font-medium text-prussian transition-all shadow-md backdrop-blur-xl border border-white/60">
              Explore Mountain
            </Link>
