      ...
      <section className="max-w-screen-xl mx-auto px-4 sm:px-8 lg:px-16 pt-24 lg:pt-32 pb-32 relative z-10" aria-label="Shop">
        ...
        <div className="text-center max-w-4xl mx-auto mb-20 lg:mb-24">
          <div className="flex items-center justify-center gap-4 mb-10">
            ...
            <p className="font-accent text-xs tracking-[0.4em] uppercase text-prussian-lt">The Collection</p>
            <div className="w-12 h-[1px] bg-prussian/30 hidden md:block"></div>
          </div>
          ...
          <p className="font-light text-lg mt-8 text-prussian-lt/90 leading-relaxed max-w-2xl mx-auto font-display">
