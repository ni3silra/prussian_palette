...
export default function AboutPage() {
  return (
    <>
        ...
        <div className="relative z-10 w-full max-w-screen-xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 items-center">
          <div className="flex flex-col justify-center">
            <div className="flex items-center justify-start gap-3 mb-8">
              <div className="w-8 h-[1px] bg-prussian/30 hidden md:block"></div>
              <p className="font-accent text-xs tracking-[0.4em] uppercase text-prussian-lt">The Story Behind The Art</p>
            </div>
            <h1 className="font-title text-4xl md:text-5xl lg:text-6xl leading-[1.15] mb-8 text-prussian tracking-tight">
              Art Did Not Find Me —<br/>It Saved Me
            </h1>
            <p className="font-display text-2xl md:text-3xl text-prussian/90 mb-6 italic">
              Hello, I am Asha — and art gave me back to myself.
            </p>
            <p className="font-body text-lg text-prussian-lt/90 font-light max-w-md leading-relaxed">
      ...
      <section className="py-32 relative" id="story" aria-label="Asha's story">
        <div className="max-w-screen-xl mx-auto px-4 sm:px-8 lg:px-16 grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-24 items-start">
          ...
          <div className="lg:col-span-7 flex flex-col pt-12">
            <div className="flex items-center justify-start gap-3 mb-8">
              <div className="w-8 h-[1px] bg-prussian/30 hidden md:block"></div>
              <p className="font-accent text-xs tracking-[0.4em] uppercase text-prussian-lt">My Story</p>
            </div>
            <h2 className="font-title text-4xl md:text-5xl mb-12 leading-tight text-prussian tracking-wide">
              A Brush. A Blank Sheet.<br/>And Everything Changed.
            </h2>
            <div className="space-y-8 font-body font-light text-lg text-prussian-lt/90 leading-[1.8] pl-0 md:pl-8 md:border-l border-prussian/20">
          ...
          <div className="lg:col-span-5 flex flex-col gap-8 relative mt-12 lg:mt-0">
            <div className="w-full relative h-[450px] rounded-t-full overflow-hidden shadow-xl border border-prussian/10">
            ...
            <div className="grid grid-cols-2 gap-8">
              <div className="w-full relative h-[250px] overflow-hidden shadow-lg border border-prussian/10 rounded-br-[4rem]">
                <Image src="/images/portfolio/IMG-20260705-WA0109.jpg" alt="Asha's painting process" fill sizes="25vw" className="object-cover" />
              </div>
              <div className="w-full relative h-[250px] overflow-hidden shadow-lg border border-prussian/10 rounded-tl-[4rem]">
            ...
            <div className="w-full relative h-[350px] rounded-b-[6rem] overflow-hidden shadow-xl border border-prussian/10">
      ...
      {/* ── CONFESSIONS ── */}
      <section className="py-32 relative bg-white/40" id="confessions" aria-label="A few things about Asha">
        <div className="max-w-screen-xl mx-auto px-4 sm:px-8 lg:px-16">
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 mb-20">
            <div className="max-w-2xl">
              <div className="flex items-center justify-start gap-3 mb-6">
                <div className="w-8 h-[1px] bg-prussian/30 hidden md:block"></div>
                <p className="font-accent text-xs tracking-[0.4em] uppercase text-prussian-lt">My Confessions</p>
              </div>
              <h2 className="font-title text-4xl md:text-5xl lg:text-6xl text-prussian tracking-wide leading-tight">
                A Few Things I Will<br/>Let You In On
              </h2>
            </div>
            <p className="text-prussian-lt/90 font-light text-lg max-w-sm pb-2">
              For anyone who wants to know the person behind the paintings — here are six truths.
            </p>
          </div>
          
          <div className="flex flex-col border-t border-prussian/20">
            {[
              ...
              <div key={i} className="flex flex-col md:flex-row gap-6 md:gap-16 items-start py-10 md:py-16 border-b border-prussian/10 group hover:bg-white/60 transition-colors duration-700 px-4 md:px-8 -mx-4 md:-mx-8">
                <span className="font-display text-6xl md:text-8xl text-prussian/10 group-hover:text-prussian/80 transition-colors duration-700 w-24 md:w-32 shrink-0 leading-none">{item.num}</span>
                <p className="text-prussian-lt/90 font-light leading-[1.8] font-body text-lg md:text-xl max-w-3xl pt-2">{item.text}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-32 relative bg-white/40" id="next-steps" aria-label="What you can do next">
        <div className="max-w-screen-xl mx-auto px-4 sm:px-8 lg:px-16">
          <div className="text-center max-w-2xl mx-auto mb-24">
            <div className="flex items-center justify-center gap-3 mb-6">
              <div className="w-8 h-[1px] bg-prussian/30 hidden md:block"></div>
              <p className="font-accent text-xs tracking-[0.4em] uppercase text-prussian-lt">Now That You Know A Little About Me</p>
              <div className="w-8 h-[1px] bg-prussian/30 hidden md:block"></div>
            </div>
            <h2 className="font-title text-4xl md:text-5xl mb-6 text-prussian tracking-wide">Here Is What You Can Do Next</h2>
            <p className="text-prussian-lt/90 font-light text-lg">Every door leads somewhere beautiful. Choose yours.</p>
          </div>
          ...
          <div className="flex flex-col gap-24 lg:gap-32 max-w-5xl mx-auto">
            ...
            <Link href="/shop" className="flex flex-col md:flex-row items-center gap-12 lg:gap-20 group cursor-pointer block">
              ...
              <div className="w-full md:w-1/2 flex flex-col justify-center">
                <div className="w-12 h-[1px] bg-prussian/30 mb-8 transition-all duration-500 group-hover:w-24"></div>
                <div className="font-accent text-[10px] tracking-widest uppercase text-prussian-lt/70 mb-4">For Walls That Deserve More</div>
                <h3 className="font-title text-4xl lg:text-5xl mb-6 text-prussian tracking-wide">Enter The Artistry</h3>
                <p className="text-prussian-lt/90 font-light text-lg mb-8 leading-relaxed max-w-sm">Original art painted from nature and everywhere I wander. Find the piece that speaks to your space.</p>
                <div className="inline-flex items-center gap-4 text-prussian font-medium uppercase tracking-widest text-xs group-hover:text-prussian-lt transition-colors">
                  Explore Paintings 
                  <span className="w-8 h-[1px] bg-prussian group-hover:w-12 transition-all duration-300"></span>
                </div>
              </div>
            </Link>
            ...
            <Link href="/connect" className="flex flex-col md:flex-row-reverse items-center gap-12 lg:gap-20 group cursor-pointer block">
              ...
              <div className="w-full md:w-1/2 flex flex-col justify-center md:items-end md:text-right">
                <div className="w-12 h-[1px] bg-prussian/30 mb-8 transition-all duration-500 group-hover:w-24 md:ml-auto md:mr-0"></div>
                <div className="font-accent text-[10px] tracking-widest uppercase text-prussian-lt/70 mb-4">No Agenda. Just Art.</div>
                <h3 className="font-title text-4xl lg:text-5xl mb-6 text-prussian tracking-wide">Send A Message</h3>
                <p className="text-prussian-lt/90 font-light text-lg mb-8 leading-relaxed max-w-sm">No formalities. Just two people who love art having a conversation. I would love to hear from you.</p>
                <div className="inline-flex items-center gap-4 text-prussian font-medium uppercase tracking-widest text-xs group-hover:text-prussian-lt transition-colors md:flex-row-reverse">
                  Say Hello 
                  <span className="w-8 h-[1px] bg-prussian group-hover:w-12 transition-all duration-300"></span>
                </div>
              </div>
