        ...
        <div className="w-full flex flex-col justify-center text-center items-center order-1 lg:order-2 pb-6 lg:pb-0 lg:px-8 lg:border-x border-prussian/20 dark:border-white/10">
          ...
          <div className="mb-6">
            <Image
              ...
              width={100}
              height={100}
              className="w-[80px] h-[80px] opacity-80 dark:brightness-0 dark:invert mx-auto drop-shadow-sm transition-opacity duration-500 hover:opacity-100"
            />
          </div>
